   ...
   public  class ResponseMapper
    {
        public List<SearchOutputData> MappingData(GraphQLResponse RoomsData ,string SessionID)
        {
            ...
            catch (Exception ex)
            {
                ...
                LoggerHelper.WriteToFile("c:/HotelsB2C/Logs/SMLogs/SearchResponseMapException", "SearchResponseMapException_" + SessionID, "SearchResponseMapException", requestData);
                throw;
            }
        }
    }
